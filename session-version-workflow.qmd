...
Have you ever commented out code that you want to delete but don't want to lose - just in case?

:::incremental
- Git allows things to be deleted and add a message as to why you did that
- Roll backs are therefore available
- And if you want to find the old code but not roll back - Git has that history
:::

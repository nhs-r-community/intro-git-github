...
::: incremental
- requires a completely new and longer workflow to work
...
Source: Happy Git and GitHub for the useR - [Is tit going to hurt](https://happygitwithr.com/big-picture.html?q=version%20control#is-it-going-to-hurt) by Jenny Bryan
...
- Team exposure: there is a lot of repeated code for tasks duplicated across many organisations
...
:::incremental
- Never having to leave one program to clean data, visualise it and do statistics

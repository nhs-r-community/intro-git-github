...
Set the token to 7 days if you are using the cloud or use `gitcreds::gitcreds_delete()` after the course for security.
...
The save workspace option to `.Rdata` can be either yes or no
...
To rename this branch (in GitHub not locally)
